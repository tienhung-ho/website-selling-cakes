<template>
  <div class="container-fluid shop">
    ...
    <div class="shop__ops row">
      <form class="shop__ops--search col-3" action="">
        <span>
      ...
      <div class="shop__ops--show col-3">
        <span>
        ...
        <span> | Show 1-{{ cakes }} of 32 results</span>
      </div>

      <div class="shop__ops--number col-2 ms-auto">
        <span>Show</span>
        <input class="ops-number" type="text" :value="cakes">
      </div>
    </div>

    <Flavor :numberOfCakes="cakes" :isShop="true" />
